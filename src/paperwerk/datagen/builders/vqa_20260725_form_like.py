...
FORM_LIKE_CLASSES: list[str] = [
    "academic_schedule_change_form",
    "academic_transcript_request",
    "accident_form",
    "account_reset_form",
    "ach_authorization_form",
    "additional_resources_form",
    "address_change_form",
    "adjustment_request",
    "administrative_performance_appraisal_form",
    ...
    "alumni_information_form",
    "apartment_request",
    "appeal_form",
    "application",
    "application_for_employment_authorization",
    "application_for_i20",
    "application_form",
    "application_packet",
    "asset_form",
    "asset_worksheet",
    "assistance_animal_health_professional_form",
    "audio_services_request_form",
    "authorization_form",
    "authorization_statement",
    "award_change_form",
    "background_check_form",
    "background_investigator_request_form",
    "banking_options",
    "beneficiary_designation",
    "bid_response",
    "billing_inquiry_form",
    "birthday_cake_order_form",
    "board_membership_roster",
    "budget_request",
    "building_permit_application",
    "business_vendor_registration_form",
    "campus_forms_request",
    "cancer_registry_form",
    "catering_order_form",
    "central_registry_release_of_information_form",
    "certificate",
    "certificate_of_compliance",
    "certificate_of_exemption",
    "certification_form",
    "certification_of_retirement",
    "chain_of_custody_form",
    "change_form",
    "change_of_address",
    "change_of_address_form",
    "change_of_address_request_form",
    "change_of_information_form",
    "change_of_name_application",
    "change_of_program_form",
    "chargeback_request",
    "check_payment_remittance_slip",
    "check_request",
    "check_request_form",
    "checklist",
    "chemical_hygiene_permit",
    "child_support_verification_form",
    "claim_form",
    "college_transcript_request",
    "commercial_invoice",
    "complaint_form",
    "compliance_form",
    ...
    "consent_form",
    "contact_list",
    "controlled_substances_discrepancy_form",
    "course_change_request",
    "course_enrollment_application",
    "course_enrollment_request",
    "course_evaluation_request",
    "course_replacement_request",
    "course_request",
    "course_roster_form",
    "credit_card_authorization",
    "credit_card_authorization_form",
    "credit_card_request_form",
    "critical_illness_claim_form",
    "customs_declaration",
    ...
    "degree_audit_form",
    "degree_verification_request",
    "dependent_verification_worksheet",
    "deposit_form",
    "diploma_request",
    "diploma_request_form",
    "direct_charge_worksheet",
    "direct_deposit_authorization",
    "direct_deposit_authorization_form",
    "direct_deposit_form",
    "direct_pay_request",
    "disability_claim_form",
    "disability_claim_statement",
    "disability_verification",
    "disability_verification_form",
    "doctoral_defense_form",
    "document_request",
    "documentation_submission_form",
    "donation_form",
    "elevation_certificate",
    "emergency_contact_form",
    "employee_gate_permit_application",
    "employee_medical_certification",
    "employee_withholding_allowance_certificate",
    "employer_data_sheet",
    "enrollment_form",
    "enrollment_forms",
    "enrollment_verification_form",
    "entry_forms",
    ...
    "faculty_conference_travel_supplemental_form",
    "fafsa_form",
    "fafsa_verification_worksheet",
    "fee_payment_form",
    "fee_transfer_details",
    "field_experience_application",
    "financial_affidavit",
    ...
    "general_approval_application",
    "graduate_certificate_application",
    "grant_application",
    "guest_account_request_form",
    "guided_study_form",
    "health_assessment_form",
    "health_forms_checklist",
    "health_history_form",
    "health_information_disclosure_request",
    "health_information_form",
    "health_questionnaire",
    "health_screening_form",
    "honors_thesis_form",
    "hotel_listing",
    "hsa_transfer_request",
    "iecex_certificate_of_conformity",
    "immigration_form",
    "immunization_exemption_certificate",
    "immunization_form",
    "incentive_reimbursement_form",
    "income_expense_verification_form",
    "income_worksheet",
    "independent_contractor_form",
    "indoor_air_quality_request_form",
    "insurance_enrollment_form",
    "insurance_waiver_request_form",
    "intake_form",
    "internship_appeal_form",
    ...
    "irs_tax_form",
    "job_application",
    "job_requisition_form",
    "lab_use_request",
    "leave_request_form",
    "license_explanation_form",
    "life_insurance_enrollment_form",
    "loan_application",
    "loan_deferment_request",
    "long_term_disability_claim_form",
    "lost_and_found_form",
    "mail_order_form",
    "mailing_information_form",
    "mandatory_information_form",
    "marital_status_form",
    "material_safety_data_sheet",
    "meal_plan_accommodation_verification_form",
    "meal_plan_request",
    "medical_evaluation_form",
    "medical_form",
    "medical_health_history_form",
    "medical_history_form",
    "medical_questionnaire",
    "membership_application",
    "membership_form",
    "merchant_application",
    "mileage_reimbursement_form",
    "minor_authorization_form",
    "minor_evaluation_request_form",
    "motor_vehicle_purchase_approval_form",
    "name_change_form",
    "name_change_request",
    "new_employee_registration_form",
    "new_fund_request_form",
    "non_degree_application",
    "observation_form",
    "onboarding_form",
    "order_form",
    "osha_form",
    "out_of_state_tuition_waiver_application",
    "parent_asset_worksheet",
    "parent_statement_of_income",
    "parental_assets_worksheet",
    "parking_appeal_form",
    "parking_form",
    "parking_permit_application",
    "parking_registration",
    "parking_request_form",
    "pass_request_form",
    ...
    "payroll_deduction_form",
    "peer_teaching_evaluation_form",
    "performance_evaluation",
    "performance_review_form",
    "permission_to_publish_form",
    "personal_data_change_request",
    "personal_data_form",
    "petition_form",
    "petty_cash_request",
    "plan_of_study_form",
    "practicum_goals_objectives_and_tasks_form",
    "pre_designation_form",
    "pre_trip_travel_info_form",
    "prescription_order_form",
    "price_list",
    "proctor_approval_form",
    "product_certification",
    "product_data_sheet",
    "product_datasheet",
    "product_sheet",
    "professional_judgment_request_form",
    "program_application",
    "program_approval_form",
    "program_request",
    "project_change_request",
    "promotion_application",
    "promotion_checklist",
    "proposal_transmittal_form",
    "purchase_order",
    "purchase_request",
    "questionnaire",
    "quotation",
    ...
    "reasonable_adjustment_application",
    "receipt_form",
    "recommendation_form",
    "reduced_course_load_request_form",
    "reference_check_form",
    "referral_form",
    "refund_application_form",
    "refund_request",
    "registration_form",
    ...
    "release_of_information_form",
    "religious_exemption_form",
    "remittance_slip",
    "remote_work_request_form",
    "replacement_diploma_request",
    "request_for_access_to_official_record",
    "request_for_bid",
    "request_for_bids",
    "request_for_portability",
    "request_for_quotation",
    "request_for_quotations",
    "request_for_temporary_paid_leaves",
    "request_form",
    "request_to_prevent_disclosure",
    "requirements_worksheet",
    "research_activities_safety_checklist",
    "research_fund_request",
    "research_maintenance_form",
    "reservation_form",
    "reservation_request",
    "retired_staff_request_form",
    "retirement_contribution_election_form",
    "retirement_plan_election_form",
    "room_use_request",
    "safety_data_sheet",
    "safety_information_form",
    "sales_and_use_tax_certificate",
    "schedule_change_form",
    "scholarship_application",
    "scholarship_award",
    "scholarship_donation_form",
    "scholarship_listing",
    "scholarship_recommendation_form",
    "school_performance_fact_sheet",
    "service_award_form",
    "service_request_form",
    "sevis_form_i20",
    "sick_leave_transfer_form",
    "sign_language_request_form",
    "sign_up_form",
    "social_security_number_change",
    "spare_parts_list",
    "speaker_course_submission_form",
    "special_circumstances_request",
    "special_consideration_request_form",
    "sponsorship_form",
    "spouse_dependent_discount_request",
    "statement_of_award",
    "statement_of_educational_purpose",
    "stock_gift_form",
    "student_application",
    "student_checklist",
    "student_financial_aid_form",
    "student_financial_services_form",
    "student_form",
    "student_refund_request",
    "student_verification_worksheet",
    "student_worksheet",
    "submission_form",
    "subscription_form",
    "table_space_request_form",
    "tax_collection_form",
    "tax_deferred_annuity_election_form",
    "tax_document",
    "tax_election_form",
    "tax_exemption_application",
    "tax_exemption_certificate",
    "tax_exemption_form",
    "tax_filing_statement",
    "tax_form",
    "tax_identification_form",
    "tax_return_form",
    "tax_return_transcript_request",
    "tax_transcript_request",
    "taxpayer_identification_form",
    "teacher_certification_authorization",
    "technical_data_sheet",
    "test_certificate",
    "thesis_proposal_approval_form",
    "third_party_access_request_form",
    "third_party_billing_statement",
    "time_sheet",
    "tort_claim_form",
    "transcript",
    "transcript_order_form",
    "transcript_release_form",
    "transcript_request",
    "transcript_request_form",
    "transfer_application",
    "transfer_information_request",
    "transfer_request",
    "transfer_request_form",
    "travel_authorization_form",
    "travel_form",
    "trusted_contact_authorization_form",
    "tuition_award_request",
    "tuition_discount_verification_form",
    "tuition_insurance_form",
    "tuition_waiver_affidavit",
    "tuition_waiver_form",
    "type_approval_certificate",
    "university_admission_application",
    "university_application_form",
    "university_complaint_form",
    "user_access_deletion_form",
    "vacation_request",
    "vaccination_form",
    "vaccine_records_request_form",
    "vehicle_request_form",
    "vendor_application",
    "vendor_authorization",
    "vendor_foreign_source_statement",
    "vendor_form",
    "vendor_information_request",
    "vendor_registration",
    "vendor_request_form",
    "verification_form",
    "verification_of_dependent",
    "verification_worksheet",
    "veterans_enrollment_certification_form",
    "volunteer_form",
    "volunteer_identification_form",
    "w2_form",
    "w2_transmittal",
    "w2g",
    "w4_form",
    "waiver_request",
    "webform_application_checklist",
    "wireless_device_request",
    "withdrawal_form",
    "withholding_certificate",
    "work_study_program_form",
    "worksheet",
]
...
def build_template_pool(min_fields: int) -> list[tuple[str, Path]]:
    ...
    if missing:
        print(
            f"warning: {len(missing)} listed class(es) not found: {missing[:8]}"
